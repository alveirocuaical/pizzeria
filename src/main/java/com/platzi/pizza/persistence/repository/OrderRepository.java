...
public interface OrderRepository extends ListCrudRepository<OrderEntity, Integer> {
    ...
    @Query(value = "call public.take_random_pizza_order('863264988','D', NULL);",nativeQuery = true)
    @Modifying
    int saveRandomOrder(@Param("id_customer") String idCustomer, @Param("method") String method);
