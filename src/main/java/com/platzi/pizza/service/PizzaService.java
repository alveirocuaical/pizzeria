...
public class PizzaService {
    ...
    */
    ...
    public Page<PizzaEntity> getAvailable(int page, int elements, String sortBy, String sortDirection) {
        ...
        return this.pizzaPagSortRepository.findByAvailable(pageRequest, 1);
    }
    ...
    public PizzaEntity getByName(String name) {
        return this.pizzaRepository.findFirstByAvailableAndAndNameIgnoreCase(1, name).
    ...
    public List<PizzaEntity> getWhitout(String ingredient) {
        return this.pizzaRepository.findAllByDescriptionNotContainingIgnoreCase(ingredient);
    }

    public List<PizzaEntity> getCheapest(double price) {
        return this.pizzaRepository.findTop3ByAvailableAndPriceLessThanEqualOrderByPriceAsc(1, price);
    }
    ...
    public int getVegan(){
        return this.pizzaRepository.countByVegan(1);
    }
